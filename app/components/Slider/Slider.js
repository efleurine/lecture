...
export default class AppIntroSlider extends React.Component {
  ...
  _renderOuterButton = (content, name, onPress) => {
    const style =
      name === "Skip" || name === "Prev"
        ? [styles.leftButtonContainer, this.props.leftButtonContainerStyle]
        : [styles.rightButtonContainer, this.props.rightButtonContainerStyle];
    return (
      <View
        style={
          this.props.bottomButton
            ? [
                ...
                this.props.bottomButtonContainerStyle
              ]
            : style
        }
      >
